 ...
 */
!function(b,c,d,e){XenForo.XenGalleryPrivacyOption=function(a){this.__construct(a)};XenForo.XenGalleryPrivacyOption.prototype={__construct:function(a){this.$select=a;this.url=a.data("descurl");this.$target=b(a.data("desctarget"));this.$type=a.data("desctype");this.url&&this.$target.length&&(a.bind({keyup:b.context(this,"fetchDescriptionDelayed"),change:b.context(this,"fetchDescription")}),a.val().length&&this.fetchDescription())},fetchDescriptionDelayed:function(){this.delayTimer&&clearTimeout(this.delayTimer);
