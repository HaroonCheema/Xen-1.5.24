...
class XenGallery_Listener
{
	...
	public static function editorSetup(XenForo_View $view, $formCtrlName, &$message, array &$editorOptions, &$showWysiwyg)
	{
		...
		{
			// Guests shouldn't be able to use this
			unset($editorOptions['json']['bbCodes']['gallery']);
		}
	}
	...
	public static function extendConvMessageDataWriter($class, array &$extend)
	{
		$extend[] = 'XenGallery_DataWriter_ConversationMessage';
	}
