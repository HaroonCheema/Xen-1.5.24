 ...
 */
class Waindigo_SocialGroups_Route_PrefixAdmin_SocialCategories extends XenForo_Route_PrefixAdmin_Nodes
{
    ...
    public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
    {
        ...
        if (!class_exists('XFCP_Waindigo_SocialGroups_ControllerAdmin_SocialCategory', false)) {
            ...
            eval('class XFCP_Waindigo_SocialGroups_ControllerAdmin_SocialCategory extends ' . $createClass . ' {}');
        }
        return $router->getRouteMatch('Waindigo_SocialGroups_ControllerAdmin_SocialCategory', $action, 'nodeTree');
    }
