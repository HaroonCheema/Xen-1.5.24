...
class Waindigo_SocialGroups_Listener_LoadClass extends Waindigo_Listener_LoadClass
{
    ...
    {
        $extend = self::createAndRun('Waindigo_SocialGroups_Listener_LoadClass', $class, $extend, 'controller');
    }

    public static function loadClassDataWriter($class, array &$extend)
    {
        $extend = self::createAndRun('Waindigo_SocialGroups_Listener_LoadClass', $class, $extend, 'datawriter');
    }

    public static function loadClassDeferred($class, array &$extend)
    {
        $extend = self::createAndRun('Waindigo_SocialGroups_Listener_LoadClass', $class, $extend, 'deferred');
    }

    public static function loadClassInstallerWaindigo($class, array &$extend)
    {
        $extend = self::createAndRun('Waindigo_SocialGroups_Listener_LoadClass', $class, $extend, 'installer_waindigo');
    }

    public static function loadClassModel($class, array &$extend)
    {
        $extend = self::createAndRun('Waindigo_SocialGroups_Listener_LoadClass', $class, $extend, 'model');
    }

    public static function loadClassRoutePrefix($class, array &$extend)
    {
        $extend = self::createAndRun('Waindigo_SocialGroups_Listener_LoadClass', $class, $extend, 'route_prefix');
    }

    public static function loadClassView($class, array &$extend)
    {
        $extend = self::createAndRun('Waindigo_SocialGroups_Listener_LoadClass', $class, $extend, 'view');
    }

    public static function loadClassHelper($class, array &$extend)
    {
        $extend = self::createAndRun('Waindigo_SocialGroups_Listener_LoadClass', $class, $extend, 'helper');
    }
}