...
class Waindigo_SocialGroups_Importer_XfAddOns_Groups extends XenForo_Importer_Abstract
{
    ...
    public function configure(XenForo_ControllerAdmin_Abstract $controller, array &$config)
    {
        ...
        return $controller->responseView('Waindigo_SocialGroups_ViewAdmin_Import_XfAddOns_Groups_Config',
            'waindigo_import_xfaddons_config_socialgroups', $viewParams);
    }
    ...
    public function getSteps()
    {
        return array(
            'socialForums' => array(
                'title' => new XenForo_Phrase('waindigo_import_social_forums_socialgroups')
            ),
            'members' => array(
                'title' => new XenForo_Phrase('waindigo_import_members_socialgroups'),
                'depends' => array(
                    'socialForums'
                )
            ),
            'joinRequests' => array(
                'title' => new XenForo_Phrase('waindigo_import_join_requests_socialgroups'),
                'depends' => array(
                    'socialForums'
                )
            ),
            'owners' => array(
                'title' => new XenForo_Phrase('waindigo_import_creators_socialgroups'),
                'depends' => array(
                    'members'
                )
            ),
            'secondaryGroups' => array(
                'title' => new XenForo_Phrase('waindigo_import_secondary_groups_socialgroups'),
                'depends' => array(
                    'members'
                )
            ),
            'threads' => array(
                'title' => new XenForo_Phrase('waindigo_import_threads_socialgroups'),
                'depends' => array(
                    'socialForums'
                )
            ),
            'posts' => array(
                'title' => new XenForo_Phrase('waindigo_import_posts_socialgroups'),
                'depends' => array(
                    'threads'
                )
            )
    ...
    public function stepPosts($start, array $options)
    {
        ...
        foreach ($posts as $post) {
			...
			$socialForum = Waindigo_SocialGroups_SocialForum::create($socialForumId);
