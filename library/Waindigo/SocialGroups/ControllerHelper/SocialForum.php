...
class Waindigo_SocialGroups_ControllerHelper_SocialForum extends XenForo_ControllerHelper_Abstract
{
    ...
    public function getWrapper(XenForo_ControllerResponse_View $subView, $forceSidebar = false)
    {
        ...
        $allMembers = Waindigo_SocialGroups_SocialForum::getInstance()->getSocialForumMembers();
        ...
        if (XenForo_Application::get('options')->waindigo_socialGroups_showSidebar || $forceSidebar) {
            $wrapper = $this->_controller->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_View',
                'waindigo_social_forum_container_socialgroups', $viewParams);
    ...
    {
        return $this->_controller->getModelFromCache('Waindigo_SocialGroups_Model_SocialForumMember');
    }
}