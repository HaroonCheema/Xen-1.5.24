 ...
 */
class Waindigo_SocialGroups_Extend_XenForo_Model_Thread extends XFCP_Waindigo_SocialGroups_Extend_XenForo_Model_Thread
{
    ...
    public function prepareThreadFetchOptions(array $fetchOptions)
    {
        ...
        if (!empty($fetchOptions['waindigo_join'])) {
            if ($fetchOptions['waindigo_join'] & self::FETCH_SOCIAL_FORUM_CREATOR) {
                $selectFields .= ',
