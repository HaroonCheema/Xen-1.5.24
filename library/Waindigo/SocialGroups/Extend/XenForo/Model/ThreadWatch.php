 ...
 */
class Waindigo_SocialGroups_Extend_XenForo_Model_ThreadWatch extends XFCP_Waindigo_SocialGroups_Extend_XenForo_Model_ThreadWatch
{
    ...
    public function sendNotificationToWatchUsersOnReply(array $reply, array $thread = null, array $noAlerts = array())
    {
        ...
        if ($xenOptions->waindigo_socialGroups_alwaysAlert && !empty($thread['social_forum_id'])) {
