 ...
 */
class Waindigo_SocialGroups_Extend_XenForo_Model_Post extends XFCP_Waindigo_SocialGroups_Extend_XenForo_Model_Post
{
        ...
        array $viewingUser = null)
    {
        ...
        if ($xenOptions->waindigo_socialGroups_primarySignature && !empty($post['primary_social_forum_id'])) {
            $socialForums[$post['primary_social_forum_id']] = array(
                'social_forum_id' => $post['primary_social_forum_id'],
                'title' => $post['social_forum_title']
            );
        }
        if ($xenOptions->waindigo_socialGroups_secondarySignature && !empty($post['secondary_social_forums'])) {
        ...
        array $nodePermissions = null, array $viewingUser = null)
    {
        if (isset($thread['social_forum_id']) && $thread['social_forum_id']) {
            ...
            if (isset($socialForum['social_forum_id'])) {
                $socialForumMembers = XenForo_Model::create('Waindigo_SocialGroups_Model_SocialForumMember')->getSocialForumUsers(
                    array(
