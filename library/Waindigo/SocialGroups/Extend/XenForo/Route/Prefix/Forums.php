 ...
 */
class Waindigo_SocialGroups_Extend_XenForo_Route_Prefix_Forums extends XFCP_Waindigo_SocialGroups_Extend_XenForo_Route_Prefix_Forums
{
    ...
    public function buildLink($originalPrefix, $outputPrefix, $action, $extension, $data, array &$extraParams)
    {
        if (isset($data['social_forum_id'])) {
            ...
            $class = XenForo_Application::resolveDynamicClass('Waindigo_SocialGroups_Route_Prefix_SocialForums',
                'route_prefix');
            $router = new $class();
