 ...
 */
class Waindigo_SocialGroups_Extend_XenForo_DataWriter_Discussion_Thread_Base extends XFCP_Waindigo_SocialGroups_Extend_XenForo_DataWriter_Discussion_Thread
{
     ...
     * @return Waindigo_SocialGroups_DataWriter_SocialForum
     */
    ...
    protected function _discussionPostSaveSocialGroups(array $messages = array())
    {
        ...
        Waindigo_SocialGroups_ControllerHelper_SocialForumThreadPost::uncacheThread($this->get('thread_id'));
    }
}

if (XenForo_Application::$versionId < 1020000) {

    class Waindigo_SocialGroups_Extend_XenForo_DataWriter_Discussion_Thread extends Waindigo_SocialGroups_Extend_XenForo_DataWriter_Discussion_Thread_Base
    {
