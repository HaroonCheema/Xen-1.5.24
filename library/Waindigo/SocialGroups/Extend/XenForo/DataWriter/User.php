 ...
 */
class Waindigo_SocialGroups_Extend_XenForo_DataWriter_User extends XFCP_Waindigo_SocialGroups_Extend_XenForo_DataWriter_User
{
    ...
    protected function _preSave()
    {
        ...
        if (!empty($GLOBALS['XenForo_ControllerPublic_Account'])) {
            ...
            if ($controller->getRouteMatch()->getAction() == 'personal-details-save') {
                ...
                if ($xenOptions->waindigo_socialGroups_allowPrimary) {
                    $primarySocialForumId = $controller->getInput()->filterSingle('primary_social_forum_id', XenForo_Input::UINT);
                }
                if ($xenOptions->waindigo_socialGroups_allowSecondary) {
        ...
        if ($this->isChanged('secondary_social_forum_ids') || !empty($GLOBALS['XenForo_Deferred_User'])) {
            ...
            $socialForumCombinationModel = XenForo_Model::create('Waindigo_SocialGroups_Model_SocialForumCombination');
