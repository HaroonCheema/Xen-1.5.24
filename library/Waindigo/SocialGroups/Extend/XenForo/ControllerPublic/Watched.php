<?php
class Waindigo_SocialGroups_Extend_XenForo_ControllerPublic_Watched extends XFCP_Waindigo_SocialGroups_Extend_XenForo_ControllerPublic_Watched
{
    ...
    public function actionSocialForums()
    {
        ...
        $fetchOptions = array(
            'join' => Waindigo_SocialGroups_Model_SocialForum::FETCH_SOCIAL_MEMBER |
                Waindigo_SocialGroups_Model_SocialForum::FETCH_AVATAR,
        ...
        return $this->responseView('Waindigo_SocialGroups_ViewPublic_Watched_SocialForums', 'waindigo_watch_social_forums_socialgroups', $viewParams);
    }
