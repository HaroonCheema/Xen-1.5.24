 ...
 */
class Waindigo_SocialGroups_Extend_XenForo_ControllerPublic_Forum extends XFCP_Waindigo_SocialGroups_Extend_XenForo_ControllerPublic_Forum
{
    ...
    {
    	if (!Waindigo_SocialGroups_SocialForum::hasInstance() && $response instanceof XenForo_ControllerResponse_View) {
