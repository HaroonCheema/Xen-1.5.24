 ...
 */
class Waindigo_SocialGroups_Extend_XenResource_DataWriter_Update extends XFCP_Waindigo_SocialGroups_Extend_XenResource_DataWriter_Update
{
    ...
    protected function _updateSocialForum($resource)
    {
        ...
        $socialForum = Waindigo_SocialGroups_SocialForum::setup($resource['social_forum_id'])->toArray();
        if (!$socialForum) {
            return false;
        }
