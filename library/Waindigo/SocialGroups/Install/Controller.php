...
class Waindigo_SocialGroups_Install_Controller extends Waindigo_Install
{

    protected $_resourceManagerUrl = 'http://xenforo.com/community/resources/social-groups-by-waindigo.891/';
        ...
        return array(
            'social_forum' => array(
                ...
                'fields' => array(
                    ...
                    'moderation_queue_handler_class' => 'Waindigo_SocialGroups_ModerationQueueHandler_SocialForum', 
                ), 
            ), 
        );
    }
    ...
    protected function _postUninstall()
    {
        if ($this->_isAddOnInstalled('EWRporta') && class_exists('EWRporta_Model_Blocks') &&
            ...
            $block = $blockModel->getBlockById('Waindigo_NewSocialForums');
            if ($block) {
