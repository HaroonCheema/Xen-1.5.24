 ...
 */
class Waindigo_SocialGroups_ControllerPublic_SocialForum extends XFCP_Waindigo_SocialGroups_ControllerPublic_SocialForum
{
    ...
    protected function _preDispatch($action)
    {
        ...
        $socialForum = null;
        if ($socialForumId) {
            $socialForum = Waindigo_SocialGroups_SocialForum::setup($socialForumId);
        } elseif ($urlPortion) {
            $socialForum = Waindigo_SocialGroups_SocialForum::setup($urlPortion);
        }
        if (($socialForumId || $urlPortion) && !Waindigo_SocialGroups_SocialForum::hasInstance()) {
            throw new XenForo_ControllerResponse_Exception(
                $this->responseError(new XenForo_Phrase('waindigo_social_forum_not_found_socialgroups')));
        }
        if (!is_array($socialForum) || !isset($socialForum['social_forum_id'])) return;
        $this->_request->setParam('node_id', $socialForum['node_id']);
        $xenOptions = XenForo_Application::get('options');
        if ($socialForum['style_id'] && $xenOptions->waindigo_socialGroups_allowStyleOverride) {
    ...
    public function actionIndex()
    {
        ...
        return $this->responseReroute('Waindigo_SocialGroups_ControllerPublic_SocialCategory', 'index');
    }
    ...
    protected function _getSocialForumResponse(XenForo_ControllerResponse_Abstract $response)
    {
        ...
        if ($response instanceof XenForo_ControllerResponse_View) {
            $socialForum = Waindigo_SocialGroups_SocialForum::getInstance()->toArray();
    ...
    {
        $socialForum = Waindigo_SocialGroups_SocialForum::getInstance()->toArray();
        $member = Waindigo_SocialGroups_SocialForum::getInstance()->getMember();
        ...
        return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_Edit', 
            'waindigo_social_forum_edit_socialgroups', $viewParams);
    }
    ...
    public function actionSave()
    {
        ...
        if (!$xenOptions->waindigo_socialGroups_allowClosed) {
            $input['social_forum_open'] = 1;
        }
        
        if (!$xenOptions->waindigo_socialGroups_allowStyleOverride) {
            $input['style_id'] = 0;
        } elseif (!$this->_input->filterSingle('style_override', XenForo_Input::UINT)) {
            $input['style_id'] = 0;
        }
        
        if (empty($xenOptions->waindigo_socialGroups_urlPortions['allow'])) {
        ...
        return $this->responseRedirect(XenForo_ControllerResponse_Redirect::SUCCESS, $return, 
            new XenForo_Phrase('waindigo_your_social_forum_has_been_updated_socialgroups'));
    }
    ...
    public function actionDelete()
    {
        ...
        if ($totalThreads) {
            return $this->responseError(new XenForo_Phrase('waindigo_social_forum_not_empty_socialgroups'));
            ...
            return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_Delete', 
                'waindigo_social_forum_delete_socialgroups', $viewParams);
        }
    }
    ...
    public function actionMove()
    {
        ...
        if ($this->isConfirmedPost()) { // move the thread
            ...
            return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_Move', 
                'waindigo_social_forum_move_socialgroups', 
                array(
                    'socialForum' => $socialForum,
                    'forum' => $forum,
                    'nodeBreadCrumbs' => $ftpHelper->getNodeBreadCrumbs($forum),
    ...
    public function actionAvatar()
    {
        ...
        return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_Avatar', 
            'waindigo_social_forum_avatar_socialgroups', $viewParams);
    }
    ...
    public function actionAvatarUpload()
    {
        ...
        // deleting
        if ($this->_noRedirect()) {
            return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_AvatarUpload', '', 
                array(
                    'socialForum' => $socialForum,
                    'sizeCode' => 'm',
                    'maxWidth' => Waindigo_SocialGroups_Model_SocialForumAvatar::getSizeFromCode('m'),
    ...
    public function actionModerator()
    {
        ...
        $writer->setExtraData(Waindigo_SocialGroups_DataWriter_SocialForumMember::DATA_SOCIAL_FORUM, $socialForum);
    ...
    public function actionAcceptInvite()
    {
        ...
        return $this->responseRedirect(XenForo_ControllerResponse_Redirect::SUCCESS, 
            XenForo_Link::buildPublicLink('social-forums', $socialForum), 
            new XenForo_Phrase('waindigo_invite_accepted_socialgroups'));
    }
    ...
    public function actionWatch()
    {
        ...
        if ($response instanceof XenForo_ControllerResponse_View) {
            ...
            $response->templateName = 'waindigo_social_forum_watch_socialgroups';
    ...
    public function actionMembers()
    {
        ...
        if ($socialForum) {
            ...
            $subView = $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForumMember_List', 
                'waindigo_member_list_socialgroups', $viewParams);
    ...
    public function actionMemberSave()
    {
        ...
        if ($socialForum) {
            ...
            if (!$input['is_social_forum_member'] && (($user['is_approved'] && $canRevokeSocialForumMembership) ||
                ...
                /*
                 * @var $dw Waindigo_SocialGroups_DataWriter_SocialForumMember
                 */
                $dw = XenForo_DataWriter::create('Waindigo_SocialGroups_DataWriter_SocialForumMember');
                $dw->setExtraData(Waindigo_SocialGroups_DataWriter_SocialForumMember::DATA_SOCIAL_FORUM, $socialForum);
            ...
            return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForumMember_Save_MemberListItem', 
                'waindigo_member_list_item_socialgroups', $viewParams);
        }
    ...
    public function actionMemberListItemEdit()
    {
        ...
        if ($socialForum) {
            ...
            return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_MemberListItemEdit', 
                'waindigo_member_list_item_edit_socialgroups', $viewParams);
        }
    ...
    public function actionInvite()
    {
        ...
        return $this->responseRedirect(XenForo_ControllerResponse_Redirect::SUCCESS, 
            XenForo_Link::buildPublicLink('social-forums/members', $socialForum), 
            new XenForo_Phrase('waindigo_invite_sent_socialgroups'));
    }
    ...
    public static function getSessionActivityDetailsForList(array $activities)
    {
        ...
        foreach ($activities as $key => $activity) {
            ...
            if ($forum) {
                $output[$key] = array(
                    new XenForo_Phrase('waindigo_viewing_social_category_socialgroups'),
                    $forum['title'],
                    $forum['url'],
                    false
                );
            } else {
                $output[$key] = new XenForo_Phrase('waindigo_viewing_social_category_socialgroups');
            }
        }
    ...
    {
        return $this->getHelper('Waindigo_SocialGroups_ControllerHelper_SocialForum')->getWrapper($subView, 
            $forceSidebar);
    }
}