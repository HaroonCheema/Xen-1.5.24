...
class Waindigo_SocialGroups_ControllerPublic_SocialCategory extends XenForo_ControllerPublic_Forum
{
    ...
    public function actionIndex()
    {
        ...
        return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_List', 
            'waindigo_social_forum_list_socialgroups', $viewParams);
    }
    ...
    public function actionForum()
    {
        ...
        return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialCategory_View', 
            'waindigo_social_category_view_socialgroups', $viewParams);
    }
    ...
    public function actionWatch()
    {
        ...
        if ($response instanceof XenForo_ControllerResponse_Redirect) {
            ...
            $response->redirectParams['linkPhrase'] = (!$stop ? new XenForo_Phrase(
                'waindigo_unwatch_social_category_socialgroups') : new XenForo_Phrase(
                'waindigo_watch_social_category_socialgroups'));
        } elseif ($response instanceof XenForo_ControllerResponse_View) {
            /* @var $response XenForo_ControllerResponse_View */
            $response->templateName = 'waindigo_social_category_watch_socialgroups';
        }
    ...
    public function actionCreateSocialForum()
    {
        ...
        return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_Create', 
            'waindigo_social_forum_create_socialgroups', $viewParams);
    }
    ...
    public function actionAddSocialForum()
    {
        ...
        if ($xenOptions->waindigo_socialGroups_moderateSocialForums) {
        ...
        return $this->responseRedirect(XenForo_ControllerResponse_Redirect::SUCCESS, $return, 
            new XenForo_Phrase('waindigo_your_social_forum_has_been_created_socialgroups'));
    }
    ...
    public function actionCreateSocialForumPreview()
    {
        ...
        return $this->responseView('Waindigo_SocialGroups_ViewPublic_SocialForum_CreatePreview', 
            'waindigo_social_forum_create_preview_socialgroups', $viewParams);
    }
    ...
    protected function _getSocialForumFetchElements(array $forum, array $displayConditions)
    {
        ...
        if (!$socialCategoryModel->canViewSocialForums($forum)) {
             ...
             * Waindigo_SocialGroups_Model_SocialForumMember
             */
            ...
            foreach ($socialForumMembers as $socialForumMember) {
                if (isset($options->waindigo_socialGroups_permissions[1]['viewSocialForum']) &&
                     ($options->waindigo_socialGroups_permissions[1]['viewSocialForum'] ||
                     ($socialForumMember['is_social_forum_moderator'] &&
                     $options->waindigo_socialGroups_permissions[2]['viewSocialForum']) ||
                     ($socialForumMember['is_social_forum_creator'] &&
                     $options->waindigo_socialGroups_permissions[3]['viewSocialForum']))) {
    ...
    protected function _getDefaultSocialForumSort(array $forum)
    {
        ...
        $defaultSortOrder = $xenOptions->waindigo_socialGroups_defaultSortOrder;
