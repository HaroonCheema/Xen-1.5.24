...
class Waindigo_SocialGroups_NodeHandler_SocialCategory extends XenForo_NodeHandler_Forum
{
        ...
        $level)
    {
        ...
        return $view->createTemplateObject('waindigo_node_level_' . $templateLevel . '_socialgroups',
            array(
                'level' => $level,
                'forum' => $node,
