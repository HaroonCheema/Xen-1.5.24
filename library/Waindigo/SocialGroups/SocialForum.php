...
class Waindigo_SocialGroups_SocialForum implements ArrayAccess
{
     ...
     *
     * @var Waindigo_SocialGroups_Model_SocialForum
     */
    ...
    public static function getSocialForumModel()
    {
        if (!self::$_socialForumModel) {
            if (!class_exists('XFCP_Waindigo_SocialGroups_Model_SocialForum', false)) {
                $createClass = XenForo_Application::resolveDynamicClass('XenForo_Model_Forum', 'model');
                eval('class XFCP_Waindigo_SocialGroups_Model_SocialForum extends ' . $createClass . ' {}');
            }
            self::$_socialForumModel = XenForo_Model::create('Waindigo_SocialGroups_Model_SocialForum');
        }
