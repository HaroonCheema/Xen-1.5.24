...
class Waindigo_SocialGroups_ViewPublic_Helper extends XenForo_ViewPublic_Base
{
    ...
    public static function renderSocialForumsListFromDisplayArray(XenForo_View $view, array $socialForums)
    {
        ...
        foreach ($socialForums as $socialForum) {
            $template = $view->createTemplateObject('waindigo_social_forum_list_item_socialgroups');
