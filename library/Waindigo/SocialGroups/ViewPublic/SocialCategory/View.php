 ...
 */
class Waindigo_SocialGroups_ViewPublic_SocialCategory_View extends XenForo_ViewPublic_Base
{
    ...
    public function renderHtml()
    {
        ...
        if (!$xenOptions->waindigo_socialGroups_showChildNodesInCategory) {
            $this->_params['renderedNodes'] = XenForo_ViewPublic_Helper_Node::renderNodeTreeFromDisplayArray($this,
                $this->_params['nodeList'], 2);
        }

        $this->_params['renderedSocialForums'] = Waindigo_SocialGroups_ViewPublic_Helper::renderSocialForumsListFromDisplayArray(
