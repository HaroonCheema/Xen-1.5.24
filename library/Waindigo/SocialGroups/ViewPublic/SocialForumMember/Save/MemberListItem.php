...
class Waindigo_SocialGroups_ViewPublic_SocialForumMember_Save_MemberListItem extends XenForo_ViewPublic_Base
{
    ...
    public function renderJson()
    {
        ...
        if (isset($this->_params['user']['username'])) {
            return XenForo_ViewRenderer_Json::jsonEncodeForOutput(
                array(
                    'templateHtml' => $this->createTemplateObject('waindigo_member_list_item_socialgroups',
                        $this->_params),
