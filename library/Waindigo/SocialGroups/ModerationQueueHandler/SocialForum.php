 ...
 */
class Waindigo_SocialGroups_ModerationQueueHandler_SocialForum extends XenForo_ModerationQueueHandler_Abstract
{
    ...
    public function getVisibleModerationQueueEntriesForUser(array $contentIds, array $viewingUser)
    {
        ...
        $socialForums = $socialForumModel->getSocialForumsByIds($contentIds,
            array(
                'join' => Waindigo_SocialGroups_Model_SocialForum::FETCH_FORUM |
                     Waindigo_SocialGroups_Model_SocialForum::FETCH_USER,
        ...
        foreach ($socialForums as $socialForum) {
            ...
            if ($canManage) {
                $output[$socialForum['social_forum_id']] = array(
                    ...
                    'contentTypeTitle' => new XenForo_Phrase('waindigo_social_forum_socialgroups'),
                    'titleEdit' => true
                );
            }
        }
